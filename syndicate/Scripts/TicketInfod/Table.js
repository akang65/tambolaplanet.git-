...
function get() {
    $.ajax({
        url: '../tempdesign/TicketInfoDashboard.aspx/gettickets',
...
function passTicketData() {
    ...
    $.ajax({
        url: '../tempdesign/TicketInfoDashboard.aspx/getTicketData',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        type: "POST",
        ...
        success: function () {
            ...
            document.getElementById("TextBoxmodalName").value = "";
            document.getElementById("TextBoxmodalNumber").value = "";
            refresh();
        }
    });
}
